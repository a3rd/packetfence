...
has_block definition =>
  (
   render_list => [ qw(description type mode group deauthMethod useCoA cliAccess VoIPEnabled VoIPLLDPDetect VoIPCDPDetect VoIPDHCPDetect VoIPAccountingDetect uplink_dynamic uplink controllerIp controllerPort) ],
  );
